$(document).ready(function () {
	...
	$('#subcategory').select2({
		placeholder: "Ürün Alt Kategorisi",
	});
	...
	function readURL2(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			reader.onload = function(e) 
			{
				$('#form__img2').attr('src', e.target.result);
			}
	...
	$('#form__img-upload2').on('change', function() 
	{
		readURL2(this);
	});
	...
	function readURL3(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			reader.onload = function(e) 
			{
				$('#form__img3').attr('src', e.target.result);
			}
	...
	$('#form__img-upload3').on('change', function() 
	{
		readURL3(this);
	});
	...
	function readURL4(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			reader.onload = function(e) 
			{
				$('#form__img4').attr('src', e.target.result);
			}
	...
	$('#form__img-upload4').on('change', function() 
	{
		readURL4(this);
	});
	...
	function readURL5(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			reader.onload = function(e) 
			{
				$('#form__img5').attr('src', e.target.result);
			}
	...
	$('#form__img-upload5').on('change', function() 
	{
		readURL5(this);
	});
	...
	function readURL6(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			reader.onload = function(e) 
			{
				$('#form__img6').attr('src', e.target.result);
			}
	...
	$('#form__img-upload6').on('change', function() 
	{
		readURL6(this);
	});
	...
	function readURL7(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			reader.onload = function(e) 
			{
				$('#form__img7').attr('src', e.target.result);
			}
	...
	$('#form__img-upload7').on('change', function() 
	{
		readURL7(this);
	});
	...
	function readURL8(input) 
	{
		if (input.files && input.files[0]) 
		{
			...
			reader.onload = function(e) 
			{
				$('#form__img8').attr('src', e.target.result);
			}
	...
	$('#form__img-upload8').on('change', function() 
	{
		readURL8(this);
	});
