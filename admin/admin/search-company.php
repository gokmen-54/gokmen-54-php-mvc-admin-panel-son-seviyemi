<?php include("Controllers/SessionController.php"); include("resources/views/header.php"); ?>
	...
	<title>Firma Ara - Web Yönetim Paneli Türkmahall Shop</title>
</head>
<body>
    <!-- MENU -->
    ...
    <?php include("Controllers/SearchCompanyController.php"); ?>
    <div class="col-12">
	<form name="search" class="form" method="post" autocomplete="off">
	<div class="row">
	<div class="col-12">
	<input type="text" name="company" class="form__input text-center" required="required" placeholder="Firma Adı">
	</div>
    
	<div class="col-12" style="text-align: center;">
	<input type="submit" class="form__btn" name="search" value="Firma Ara">
	</div>
    ...
    { 
        ...
        <a class="dashbox__refresh" href="search-company" title="Yenile"><i class="icon ion-ios-refresh"></i></a>
    ...
    <h6 class="modal__title">Kullanıcıyı Yasakla</h6>
    <p class="modal__text">Bu kullanıcıyı yasaklamak istediğinizden emin misiniz ?</p>
    <div class="modal__btns">
    <button type="button" class="modal__btn modal__btn--apply" onclick="window.location.href='ban-user'">Yasakla</button>
