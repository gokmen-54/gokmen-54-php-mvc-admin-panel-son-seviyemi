...
<body>
    ...
    <?php include("Controllers/SearchBlogController.php"); ?>
    <div class="col-12">
	<form name="blog" class="form" method="post" autocomplete="off">
	<div class="row">

	<div class="col-12">
	<input type="text" name="title" class="form__input text-center" required="required" placeholder="Blog Başlığı">
	</div>

	<div class="col-12" style="text-align: center;">
	<input type="submit" class="form__btn" name="search" value="Blog Ara">
	</div>
    ...
    { 
        ...
        <a class="dashbox__refresh" href="search-bog" title="Yenile"><i class="icon ion-ios-refresh"></i></a>
        <a class="dashbox__more" href="view-product" title="Tüm Blogları Görüntüle">Tümü</a>
        </div>
        </div>
